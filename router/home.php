...
Route::rule('/api/wx_return_url','index/Api/wx_return_url');
Route::rule('/api/wx_notify_url','index/Api/wx_notify_url');
Route::rule('/api/wxlogin','index/Api/wxlogin');
Route::rule('/buy/wxpay','index/Buy/wxpay');
Route::rule('/getwximg','index/Iam/getwximg');
/**
 *  插件路由
 */
//虚拟主机
...
Route::rule('console/host/updatelist','index/Host/updatelist');
