...
INSERT INTO `gee_msgmodel` VALUES (19, '3', 'smartOverdue', '智能建站过期提醒', '尊敬的用户您好，您的智能站点{name}即将到期，请尽快续费以免服务过期造成不便影响。', '', '', '0', 1590976629, 1598518524);
INSERT INTO `gee_msgmodel` VALUES (20, '3', 'loginRemind', '用户登录提醒', '您的账号于{time}登录，如不为本人操作请尽快修改密码！', '', '', '0', 1598603959, 1598603974);
