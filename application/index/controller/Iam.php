...
class Iam extends Common
{
    ...
    public function overview()
    {
        ...
        // dump($_SERVER);
        // $test = & load_wechat('User');
        // $result = $test->getUserInfo(session('_userInfo')['openid']);
        ...
        // }
        // $params = [
        //   'first'=>'您的云主机产品即将到期或已到期,请您尽快续费',
        //   'keyword1'=>session('_userInfo')['name'],
        //   'keyword2'=>'测试产品',
        //   'keyword3'=>'1.1.1.1',
        //   'keyword4'=>date('Y-m-d',time()),
        //   'remark'=>'为了不影响您使用，请您尽快续费！',
        // ];
        
        // $res = guestbook('2NMroKmxyiJRadorUAT0IuBszmQcyZ8xHmVx4cHoBQ4',$params);

        // dump($res);

        // -QhFySOKvOkgBXL3mQQGySDaet-nVPEAS5fujY99v9I
    ...
    public function getwximg(){
      ...
      $redirect_uri = urlencode($_SERVER['REQUEST_SCHEME'].'://' . $_SERVER['HTTP_HOST'] .'/api/wxlogin?uid='.session('_userInfo')['id']); //这个是设置参数和授权后重定向的回调链接地址
