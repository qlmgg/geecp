...
use app\manager\model\GeeServerAddedItems;
use app\manager\model\GeeOsgroup;
use app\manager\model\GeeOstype;
...
class GeeServer extends Model
{
	...
	public function getAddedsAttr($var, $data)
  {
    ...
    foreach(json_decode($data['server_added'],true) as $k=>$v){
