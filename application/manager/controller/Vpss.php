...
use app\manager\model\GeeVps; // 用户vps表
use addons\vps\vps; // 调用vps插件
use app\manager\model\GeeVhostConfig; //vps表
use app\manager\model\GeeVhostGroup; //vps表
use app\manager\model\GeeVhost; //vps表
