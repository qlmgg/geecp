...
return [
    ...
    'view_replace_str'=> [
        '__THEMES__' => '/themes',
        '__TEMP__' => '/template/default/themes',
    ],
    // 默认跳转页面对应的模板文件
    'dispatch_success_tmpl' => APP_PATH . '/common/tpl/dispatch_jump_success.html',
    'dispatch_error_tmpl' => APP_PATH . '/common/tpl/dispatch_jump_error.html',
     ...
     */
    'wxpay'=>[
      'img' => '/uploads/20200828/5f48d445cf863.jpg',
      'appid' => 'wx1dfeb43f767c2594',
      'mchid' => '1336909201',
      'key' => '85744677c248cc4b2ae573e2279cb2db',
      'appsecret' => 'qwertyuiopasdfghjklzxcvbnm123457',
    ],
    ...
    'geecp'=> [
        ...
        //应用授权AK
        'ak' => '25764bda8e9b4ecc87fbc3d3d64f6a0f',
        //版本号
        'version' => '2.1.5',

        //API接口地址
        'api_url' => 'https://update-source.geecp.com',

        //授权检查地址
        'auth_url' => 'http://106.12.15.5:10030',
        // 'auth_url' => 'http://192.168.0.183:8080',

        'auth_api' => [
            'authorized-purchase-api-doModById' => '/api/sqfwxt/authorizedPurchase/doModById',
            'authorized-purchase-api-doGetList' => '/api/sqfwxt/authorizedPurchase/doGetList',
