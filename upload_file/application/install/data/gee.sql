...
-- ----------------------------
INSERT INTO `gee_annexconfig` VALUES (1, '0', '', '', '', '', '0', '0', NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', 1558084404, 1587457290);
...
CREATE TABLE `gee_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1292 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `gee_msgmodel` VALUES (1, '3', 'defaultEmail', '默认测试邮件', '这是一个默认邮件模板\n网站名称：{basic_name}|\n联系邮箱：{basic_email}|\n网站首页域名：{basic_url}|\nlogo图片路径：{basic_logo}|\nICP备案：{basic_icp}|\n网安备案：{basic_beian}|\nIDC备案：{basic_idc}|\nISP备案：{basic_isp}|\n自定义变量：{basic_qwejo}|\n邮件随机验证码：{email_code}|\n短信随机验证码：{sms_code}', NULL, '0', 1557988637, 1585123324);
INSERT INTO `gee_msgmodel` VALUES (13, '3', 'serverOverdue', '租用托管服务器过期提醒', '尊敬的用户您好，您的物理服务器{name}即将到期，请尽快续费以免服务器过期造成不便影响。', '', '0', 1590040961, 1590041289);
INSERT INTO `gee_msgmodel` VALUES (4, '0', 'registerCode', '注册验证码模版', '您正在注册{basic_name}账号，验证码为{sms_code}，请勿将验证码告诉他人。', '10002', '0', 1585553037, 1585553432);
INSERT INTO `gee_msgmodel` VALUES (5, '0', 'retrieveCode', '找回密码验证码模版', '您正在操作找回{basic_name}账号密码，您的验证码为{sms_code},请勿将验证码告诉他人。', '10003', '0', 1585553123, 1585553183);
INSERT INTO `gee_msgmodel` VALUES (6, '0', 'changeMobileCode', '修改手机号', '您正在操作修改手机号操作，您的验证码为{sms_code}，请勿将验证码告诉他人。', '10004', '0', 1585553168, 1585553168);
INSERT INTO `gee_msgmodel` VALUES (7, '1', 'domainRegister', '域名注册成功', '尊敬的用户您好，您的域名{S1}已经成功注册，请登陆控制台进行操作。感谢您对{basic_name}的支持。', '10005', '0', 1585553263, 1585553550);
INSERT INTO `gee_msgmodel` VALUES (8, '1', 'cloudserverRegister', '云主机开通短信', '尊敬的用户您好，您的云主机实例{s1}已经开通，有效期至{s3}。请您登陆控制台进行操作。', '10006', '0', 1585553309, 1585553536);
INSERT INTO `gee_msgmodel` VALUES (9, '0', 'cloudserverReseter', '云主机重置密码验证码', '尊敬的用户您好，您正在重置云主机实例{s1}的管理密码，验证码为{sms_code}，请勿告知他人。', '10007', '0', 1585553352, 1585553523);
INSERT INTO `gee_msgmodel` VALUES (10, '1', 'vhostRegister', '虚拟主机开通成功', '尊敬的用户您好，您的虚拟主机{s2}已经开通，请您登陆控制台进行操作。', '10008', '0', 1585553401, 1585553504);
INSERT INTO `gee_msgmodel` VALUES (11, '1', 'serverRegister', '物理服务器开通成功', '尊敬的用户您好，您的物理服务器{name}已经开通，稍后正式交付后会有短信再次提示，请您关注短信通知。', '10009', '0', 1585553463, 1585553467);
INSERT INTO `gee_msgmodel` VALUES (12, '1', 'serverDelivery', '物理服务器交付', '尊敬的用户您好，您的物理机实例{s2}已经成功交付，请您登陆控制台查看。', '10010', '0', 1585553495, 1585553495);
INSERT INTO `gee_msgmodel` VALUES (14, '3', 'cdnOverdue', '高防CDN服务器过期提醒', '尊敬的用户您好，您的高防CDN服务器{name}即将到期，请尽快续费以免服务过期造成不便影响。', '', '0', 1590040961, 1590041289);
INSERT INTO `gee_msgmodel` VALUES (15, '3', 'domainOverdue', '域名过期提醒', '尊敬的用户您好，您的域名{name}即将到期，请尽快续费以免服务过期造成不便影响。', '', '0', 1590040961, 1590041289);
INSERT INTO `gee_msgmodel` VALUES (16, '3', 'hostOverdue', '虚拟主机过期提醒', '尊敬的用户您好，您的虚拟主机{name}即将到期，请尽快续费以免服务过期造成不便影响。', '', '0', 1590040961, 1590041289);
INSERT INTO `gee_msgmodel` VALUES (17, '3', 'cloudserverOverdue', '云服务器过期提醒', '尊敬的用户您好，您的云服务器{name}即将到期，请尽快续费以免服务过期造成不便影响。', '', '0', 1590040961, 1590041289);
INSERT INTO `gee_msgmodel` VALUES (18, '3', 'vpsOverdue', '云主机VPS过期提醒', '尊敬的用户您好，您的云主机VPS{name}即将到期，请尽快续费以免服务过期造成不便影响。', '', '0', 1590040961, 1590041289);
INSERT INTO `gee_msgmodel` VALUES (19, '3', 'smartOverdue', '智能建站过期提醒', '尊敬的用户您好，您的智能站点{name}即将到期，请尽快续费以免服务过期造成不便影响。', '', '0', 1590976629, 1590976629);
...
INSERT INTO `gee_ostype` VALUES (1, 'CentOs 7.6 ', 1, 0, '[{\"name\":\"nokvm\",\"id\":0}]', 1574661500, 1582098734);
...
-- ----------------------------
INSERT INTO `gee_webbasic` VALUES (1, 'GEECP', '975827527@qq.com', 'https://www.geecp.com', '/uploads/20200413/5e940054e5c3a.png', '/uploads/20200413/5e940052f0380.png', '/uploads/20200413/5e94005723a95.png', 'GEECP', 'GEECP', 'ICP', 'BEIAN', 'IDC', 'ISP', '0', 'GEECP', 'GEECP', 'GEECP', 'GEECP', 'GEECP', 0, 1587089840);
...
INSERT INTO `gee_webroute` VALUES (6, '云虚拟主机', '/host', 'host', 0, NULL, '1', 'icon-cvh', '0', '0', 1, NULL, NULL, 1557194766, 1557194766);
...
INSERT INTO `gee_webroute` VALUES (278, '渠道代理', '/home/h_agent', 'h_agent', 275, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
INSERT INTO `gee_webroute` VALUES (279, '云服务器', '/home/h_ecs', 'h_ecs', 275, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
INSERT INTO `gee_webroute` VALUES (280, '内容分发', '/home/h_cdn', 'h_cdn', 275, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
INSERT INTO `gee_webroute` VALUES (281, '关于我们', '/home/h_about', 'h_about', 275, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
INSERT INTO `gee_webroute` VALUES (282, '域名', '/home/h_domain', 'h_domain', 275, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
INSERT INTO `gee_webroute` VALUES (283, '虚拟主机', '/home/h_host', 'h_host', 275, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
INSERT INTO `gee_webroute` VALUES (284, 'IDC', '/home/h_idc', 'h_idc', 275, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
INSERT INTO `gee_webroute` VALUES (285, 'SSL证书', '/home/h_ssl', 'h_ssl', 275, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
...
INSERT INTO `gee_webroute` VALUES (318, '智能建站管理', '/smartsite/index', 'index', 261, 0, '1', NULL, '1', '0', 0, NULL, NULL, 155555555, 15555555);
INSERT INTO `gee_webroute` VALUES (319, '创建智能建站', '/smartsite/add', 'add', 261, 261, '1', NULL, '1', '0', 0, NULL, NULL, 12222222, 1222222222);
INSERT INTO `gee_webroute` VALUES (320, '创建智能建站验证', '/smartsite/addAuth', 'addAuth', 261, 0, '1', NULL, '0', '0', 0, NULL, NULL, 12222222, 1222222222);
INSERT INTO `gee_webroute` VALUES (321, '获取智能建站价格', '/smartsite/getprice', 'getprice', 261, 0, '1', NULL, '0', '0', 0, NULL, NULL, 1222222222, 1555555555);
INSERT INTO `gee_webroute` VALUES (323, '智能建站控制器', '/smartsite/manager', 'manager', 261, 0, '1', NULL, '0', '0', 0, NULL, NULL, 155555, 555555);
INSERT INTO `gee_webroute` VALUES (324, '智能建站修改密码', '/smartsite/changepass', 'changepass', 261, 0, '1', NULL, '0', '0', 0, NULL, NULL, 155555555, 15555555);
INSERT INTO `gee_webroute` VALUES (325, '智能建站获取密码', '/smartsite/getpass', 'getpass', 261, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
INSERT INTO `gee_webroute` VALUES (326, '智能建站列表更新', '/smartsite/updatelist', 'updatelist', 261, 0, '1', NULL, '0', '0', 0, NULL, NULL, 0, 0);
