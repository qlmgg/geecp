...
class Index extends Controller
{
    ...
    public function step4()
    {
        ...
        if ($this->request->isPost()) {
            ...
            //管理员信息
            $admin_ak      = $request_data['admin_ak'];
    ...
    public function create_admin()
    {
        ...
        if (empty($admin_info['ak'])) {
            return json(['staus'=>'1','message'=>'非法安装！未填写授权AK']);
        }
        try {
            $now_time = time();
            $admin_indata = [
            ...
            //将AK写入config.php
            setconfig(['geecp','ak'],[$admin_info['ak']]);
