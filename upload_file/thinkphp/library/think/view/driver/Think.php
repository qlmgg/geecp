...
class Think
{
    ...
    public function __construct($config = [])
    {
         ...
         * User: ylsq
         * Intro: [manager|common|extra|instasll|api]等模块在启用template的情况下不沿用TP5模板机制
         */
        $exception = ['/application/manager', '/application/common', '/application/extra', '/application/install', '/application/api'];
        ...
        if (empty($this->config['view_path'])) {
            ...
            if (!empty($this->config['theme']) && !!$keys) {
