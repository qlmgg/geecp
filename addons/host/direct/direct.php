...
class direct extends Addons
{
    ...
    public function uninstall()
    {
        ...
        $host = new GeeHost();
        $host->where('plug_name = "direct"')->delete();
        // return $ret;

        //先删除目录下的文件：
        $dir = './../addons/host/direct';
        $this->deldir($dir);
        $dir = './../application/direct';
        $this->deldir($dir);
        return $ret;
    }
