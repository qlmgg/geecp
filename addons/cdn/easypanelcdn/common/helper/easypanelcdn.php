<?php
namespace addons\cdn\easypanelcdn\common\helper;
/**
 * Author: 镜面王子 <153555712@qq.com>
 * User: jingmian
 */
use addons\cdn\easypanelcdn\common\library\WhmCall;
use addons\cdn\easypanelcdn\common\library\WhmClient;
...
class easypanelcdn{
    ...
    public function easypanel_make_whm($params) {
        $whm = new \addons\cdn\easypanelcdn\common\library\WhmClient();
